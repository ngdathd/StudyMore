...
public class TimelinePostAdapter extends RecyclerView.Adapter
    ...
    public TimelinePostAdapter(Context context, IPostAdapter mIPostAdapter) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        viewHolderPost.toggleButton.setVisibility(View.GONE);
    }
